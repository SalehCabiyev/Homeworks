...
double calculateFare(double distance) {
    const double pricePerKm = 2.0; // стоимость за километр
...
public:
    ...
    void add_trip( const std::string& trip) {
        ...
        do {
            ...
            switch (choice) {
                ...
                case 3: {
                    ...
                    add_trip(client->getcurrenttrip());
